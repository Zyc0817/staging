<template>
    <div class="headTabBar">
        <div class="headTabBarItem" v-for="(i,k) in headTabBar" :key="k" @click="headTabBarHandleClick(k)" :class="{selectTabBar:checkHeadTabBar[k]}">
            <div class="number" :style="{color:colors[k]}">{{i.num}}</div>
...
export default {
    ...
    methods: {
        ...
        headTabBarHandleClick(k) {
            ...
            if (k==1) {
                obj.position.push(this.allList[0])
            } else if (k==2) {
                obj.position.push(this.allList[1])
            } else if (k==3) {
                obj.position.push(this.allList[2])
            } else if (k==4) {
                obj.position.push(this.allList[3])
            } else if (k==0) {
                obj.position = this.allList
            } 
